...
public class Interview0102 {
    ...
    public static boolean CheckPermutation2(String s1, String s2){
        ...
        Map<Character, Integer> charCount = new java.util.HashMap<>(100);
        for (int i=0 ; i < s1.length() ; i++){
    ...
    public static boolean CheckPermutation1(String s1, String s2) {
        ...
        Map<Character, Integer> charCount1 = new java.util.HashMap<>(100);
        Map<Character, Integer> charCount2 = new java.util.HashMap<>(100);
        for (int i=0 ; i < s1.length() ; i++){
            char ch1 = s1.charAt(i);
            char ch2 = s2.charAt(i);
